...
| `byte_length.rs` | STRING-to-INT64 projections, UTF-8 byte counts, empty/maximal/NULL values, literal ownership, aliases, conditional dependencies, typed materialization, rejected forms, cancellation, abandonment and reopen. |
