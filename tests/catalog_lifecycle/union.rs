...
#[test]
fn public_union_checks_source_pool_and_preserves_full_width_outputs() {
    check_union_width();
}

#[test]
fn public_union_full_width_preparation_and_execution_fit_the_small_stack() {
