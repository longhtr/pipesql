#!/usr/bin/env python3
"""Check the Markdown link reader against literal snippets and temporary documents.

Valid encoded paths and repeated headings must resolve; missing paths, anchors,
reference definitions and repository escapes must fail with useful locations.
Fenced examples stay outside discovery. Run directly or through maintenance;
expected links and anchors are literal, not generated by the reader under test.
"""
