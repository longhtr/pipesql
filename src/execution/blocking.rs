...
// Keep one checked record from each run. Each step writes the lesser record and
// advances only that cursor. The previous output key detects reversed or repeated
