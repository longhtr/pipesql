...
// Other owners must remain parked while this query advances. An increase over
// their temporary reservations identifies this report's first spill allocation.
