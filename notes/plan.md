...
failed repair and a wrong-answer control. Both platform scopes and fresh lessons
pass. No engine change was needed; broader recovery qualification remains open.
...
Independent raw graph and literal grouped-answer oracles agree. No engine or
native observer change was required; broader durability remains unqualified.
...
publication/reclamation, cancellation, pinned-plan reuse and an effective unlink
control. Both platform catalog/example suites and fresh lessons pass. No engine
repair was required; the preceding full native/persistence checkpoint remains
unchanged.
...
outweigh several feature goals. The first five goals now provide observed costs
