...
| [except.rs](../src/execution/blocking/except.rs) | Complete-row merge difference over two admitted sorted inputs, left-only representatives, and retained replay. |
