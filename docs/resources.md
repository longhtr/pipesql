...
operations add no allocation owner or temporary storage. MOD and DIV use the same
two-input lane transition with INT64 operands. Their calls share the bounded
argument-frame representation with SAFE_DIVIDE. DIV uses checked integer
